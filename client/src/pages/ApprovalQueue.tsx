...
import { CheckCircle2, XCircle, ClipboardList, Inbox, Clock, History } from "lucide-react";
...
function getInitialTab(): StatusFilter {
  if (typeof window !== "undefined") {
    ...
    if (p === "approved" || p === "rejected" || p === "all") return p;
  }
  return "pending";
}
...
export default function ApprovalQueue() {
  ...
  // Fetch all consultant queue items (pending + approved + rejected)
  ...
  return (
    <div className="p-6 max-w-3xl">
      ...
      {/* Filter tabs */}
      <div className="flex gap-1 bg-muted/40 rounded-xl p-1 mb-5 border border-border">
        {TABS.map(tab => {
                  ...
                  <div className="border-t border-border px-5 pb-5 pt-4 space-y-4">
                    ...
                    {!isPending && audit.decisionNote && (
                      <div className={`p-3 rounded-lg text-sm ${
                        audit.status === "approved" ? "bg-emerald-50 border border-emerald-200 text-emerald-800" : "bg-red-50 border border-red-200 text-red-800"
                      }`}>
                        <p className="text-xs font-semibold mb-1">Decision Note</p>
